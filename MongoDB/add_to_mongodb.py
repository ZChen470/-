...
image_files = {
"Barred Spiral":"Barred Spiral.jpg",
"Cigar Shaped Smooth":"Cigar Shaped Smooth.jpg",
"Disturbed":"Disturbed.jpg",
"Edge-on with Bulge":"Edge-on with Bulge.jpg",
"Edge-on without Bulge":"Edge-on without Bulge.jpg",
"In-between Round Smooth":"In-between Round Smooth.jpg",
"Merging":"Merging.jpg",
"Round Smooth":"Round Smooth.jpg",
"Unbarred Loose Spiral":"Unbarred Loose Spiral.jpg",
"Unbarred Tight Spiral":"Unbarred Tight Spiral.jpg"
}

# 合并字典
combined = []
for key in descriptions:
    if key in represents:
        combined.append({
            "category": key,
            "description": descriptions[key],
            "name": represents[key]["name"],
            "profile": represents[key]["profile"],
            "source": represents[key]["source"]
        })
...
async def insert_data():
    for item in combined:
        ...
        if category in image_files:
            image_path = image_files[category]
            item["image"] = encode_image_to_base64(image_path)
    result = await collection.insert_many(combined)
